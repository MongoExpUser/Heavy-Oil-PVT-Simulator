...
public class PREos
{
   ...
   public double [] compute(int n, int [] typeOfHC, double [] MassC1_C10_CO2_H2S_N2, double T_in_K, double P_in_MPa, boolean moleFraction,
                            double [] moleFractionC1_C10_CO2_H2S_N2, ThermodynamicProperties tp)
                            {
  
   double R = 8.31447; ///Gas universal constant in SI unit (N/m)
   double P = P_in_MPa;
   double T = T_in_K/* @License Starts
 *
