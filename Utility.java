...
public class Utility
{
 ...
 static double sumArray(double [] A){
  ...
  static void printArrayToSystem(double [] A){
  ...
  static double minimumOfArrayValues(double [] A){
   ...
   static double vapourCompressibilty(double [] A){
   ...
   static double liquidCompressibilty(double [] A){
  ...
  static double [] thomasAlgorithmSolution (double upperElements [], double diagonalElements [], double lowerElements [], double rhsElements []){
